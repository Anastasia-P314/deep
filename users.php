...
$sql = "SELECT * FROM users LEFT JOIN users_general_info ON users.id=users_general_info.id LEFT JOIN avatars ON users.id=avatars.id";
$users = $pdo->prepare($sql);
$users->execute();

// $users = $statement->fetch(PDO::FETCH_ASSOC);$users = $statement->fetch(PDO::FETCH_ASSOC);  
//var_dump($users);die;

// $users = array(
//     ['background-image' => 'img/demo/avatars/avatar-b.png',
//     'name' => 'Oliver Kopyov',
...
//     'role' => 'user',
//     ],
//     ['background-image' => 'img/demo/avatars/avatar-c.png',
//     'name' => 'Alita Gray',
...
//     'role' => 'admin',
//     ],
    // ['background-image' => 'img/demo/avatars/avatar-e.png',
    ...
    // 'role' => 'user',
    // ],
    // ['background-image' => 'img/demo/avatars/avatar-k.png',
    // 'name' => 'Jim Ketty',
    ...
    // 'role' => 'user',
    // ],
    // ['background-image' => 'img/demo/avatars/avatar-g.png',
    // 'name' => 'Dr. John Oliver',
    ...
    // 'role' => 'user',
    // ],
    // ['background-image' => 'img/demo/avatars/avatar-h.png',
    // 'name' => 'Sarah McBrook',
    ...
    // 'role' => 'user',
    // ],
    // ['background-image' => 'img/demo/avatars/avatar-i.png',
    // 'name' => 'Jimmy Fellan',
    ...
    // 'role' => 'user',
    // ],
    // ['background-image' => 'img/demo/avatars/avatar-j.png',
    // 'name' => 'Arica Grace',
    // 'profession' => 'Accounting, Gotbootstrap Inc.',
...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <?php //return_flash_message("success") 
            if(isset($_SESSION['flash_message_name'])){
                echo return_flash_message($_SESSION['flash_message_name']);
            };
            ?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    //{echo $user['role'];};//{echo 'class="hidden"';} ?>

                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user['name']?>
                                        <i <?php echo $none?> class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i <?php echo $none?> class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                    </a>
                                    

                                    <div <?php echo $none?> class="dropdown-menu">
                                    
                                        <a class="dropdown-item" href="edit.php<?php echo '?id='.get_user_by_email($user['email'])['id'] ?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="security.php<?php echo '?id='.get_user_by_email($user['email'])['id'] ?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status.php<?php echo '?id='.get_user_by_email($user['email'])['id'] ?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="media.php<?php echo '?id='.get_user_by_email($user['email'])['id'] ?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete.php<?php echo '?id='.get_user_by_email($user['email'])['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
