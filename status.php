...
$user = check_rights_to_edit('statuses'); //echo $user['status'];die;
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="set_status.php<?php echo "?id=".$_GET['id'] ?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="status">
                                                ...
                                                <option value="<?php echo $status ?>" <?php if($user['status']==$status ){echo 'selected="true"';} ?>>
                                                    <?php echo $text ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
