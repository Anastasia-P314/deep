...
$user = check_rights_to_edit('users_general_info'); 
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="edit_model.php<?php echo "?id=".$_GET['id'] ?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $user['profession'] ?>" name="profession">
                                </div>
